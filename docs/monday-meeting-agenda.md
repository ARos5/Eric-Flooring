...
## 1. Show the mockup (5 min)
- Open `mockup/the-lvp-warehouse-newsletter.html` **on your phone** — that's the "wow."
- Point out: his logo up top, real Northeast FL market numbers, featured floors, the **$1.49 investor
  flip special**, and the **sponsor slot** (his future ad revenue).
...
- [ ] **Brand colors** (or confirm black/white + the amber accent)
- [ ] **5–10 real design photos** + names + specs (wear layer, width, core)
...
### Reminders
- 🚫 The **$1.49 flip line stays under "The LVP Warehouse" — never the CASE brand** (CASE doesn't
  know about the side supplier).
- 🤝 Settle the **barter** (Eric does Alex's floors in exchange) — and have fun with it.

### Reference docs
- Spec: `specs/newsletter.md` · Plan: `docs/implementation-plan.md` · Data: `docs/data-sources.md`
- Transcript: `docs/call-transcript-2026-06-25.md`
